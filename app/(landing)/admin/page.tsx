          ...
          <div id="menu" className="flex flex-col space-y-2 my-5">
            ...
            >
              <div className="flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                ...
                <div>
                  <p className="font-bold text-base lg:text-lg text-slate-800 leading-4 group-hover:text-indigo-400">
                    Dashboard
                  </p>
            ...
            >
              <div className="relative flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                ...
                <div className="absolute -top-3 -right-3 md:top-0 md:right-0 px-2 py-1.5 rounded-full bg-indigo-800 text-xs font-mono font-bold text-white">
                  23
                </div>
              </div>
            </a>
            ...
            <p className="overflow-x-scroll">
              <table className="w-full whitespace-nowrap">
                <thead className="bg-slate-700">
                  <th className="text-left py-3 px-2 rounded-l-lg text-white">Name</th>
                  ...
                  <th className="text-left py-3 px-2 rounded-r-lg text-white">Actions</th>
                </thead>
